<div class="sidebar">
    ...
    <ul class="nav-list">
        ...
        <li>
            <a href="../page/analysis-group.php">
                <i class='bx bx-pie-chart-alt-2'></i>
                <span class="links_name">SAR Analysis</span>
            </a>
            <span class="tooltip">SAR Analysis</span>
        </li>
        <li>
            <a href="../page/warning.php">
                <i class="las la-envelope-open"></i>
                <span class="links_name">Warning Letters</span>
            </a>
            <span class="tooltip">Warning Letters</span>
        </li>
        <li class="profile">
            <a href="../profile/coordinator.profile.php" id="profile-page">
